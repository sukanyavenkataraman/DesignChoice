...
decay_rate = 0.99
epochs_hb = 16
epochs_hb_only = 10#64 # since 64log64 is 192 which is approx no. of phis + 16log16. Please note that these have to approx. match to be able to compare HB and HB+DC
epochs_dc = 1
...
if not os.path.exists('Output_MainTestSetup_Medical'):
    os.mkdir('Output_MainTestSetup_Medical')
    ...
    for j in range(len(batch_sizes)):
        ...
        for k in range(len(learning_rates)):
            ...
            nn_hb = deepnn.deepNN(num_hidden_layers=depth - 1,
                                  ...
                                  save_models=True,
                                  model_name='HB_test'+str(learning_rate))
            ...
            first_line = str(depth) + '\t' + str(batch_size) + '\t' + str(learning_rate) + '\n'
